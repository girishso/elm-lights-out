...
var _user$project$Main$toggleLights = F2(
	function (ix, list) {
		return A2(
			_elm_lang$core$List$indexedMap,
			F2(
				function (i, isOn) {
					return _elm_lang$core$Native_Utils.eq(ix, i) ? _elm_lang$core$Basics$not(isOn) : (_elm_lang$core$Native_Utils.eq(ix, i + 1) ? _elm_lang$core$Basics$not(isOn) : (_elm_lang$core$Native_Utils.eq(ix, i - 1) ? _elm_lang$core$Basics$not(isOn) : isOn));
				}),
			list);
	});
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				isOn: A2(_user$project$Main$toggleLights, _p0._0, model.isOn)
			});
	});
var _user$project$Main$init = {
	isOn: _elm_lang$core$Native_List.fromArray(
		[true, true, true])
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[]),
				A2(_elm_lang$core$List$indexedMap, _user$project$Main$btn, model.isOn))
			]));
};
